// app/(admin)/leafway/solutions/admin/page.tsx
...
// Admin uses MobileMenu from layout; no direct StaggeredMenu here
import { type StatusSummary, type TripRequestRow } from "./trip-requests-table";
import TripRequestsTable from "./trip-requests-table";
...
export default async function TripLeadsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white relative">
      {/* MobileMenu is rendered in admin layout globally */}
